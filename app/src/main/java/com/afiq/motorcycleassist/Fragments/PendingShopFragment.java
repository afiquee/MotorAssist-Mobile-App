...
public class PendingShopFragment extends Fragment implements ShopListAdapter.OnListListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        shopVM.getPendingShops().observe(this, shops -> {
            if(shops == null){
                msg.setVisibility(View.VISIBLE);
                msg.setText("No Pending Shop");
            }
            else{
                shopList = shops;
