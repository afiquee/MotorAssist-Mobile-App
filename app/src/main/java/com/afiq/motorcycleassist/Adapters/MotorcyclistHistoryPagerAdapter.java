...
import com.afiq.motorcycleassist.Fragments.RescuerHistoryFragment;

public class MotorcyclistHistoryPagerAdapter extends FragmentStatePagerAdapter {

    int mNumOfTabs;

    public MotorcyclistHistoryPagerAdapter(FragmentManager fm, int NumOfTabs) {
